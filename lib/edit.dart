...
Future<Widget> editTravelForm(int id) async {
  Travel dataMap;
  dataMap = await getItemById(id);
  var arrivalPlace,
      receiptLocation,
      arrivalDate,
      departurePlace,
...
Future<Widget> editPersonalForm(int id) async {
  OtherExpense dataMap;
  dataMap = await getItemByIdOtherExpense(id);
  var type,
      details,
      amount_paid,
      receipt_details,
  ...
  return Form(
    child: Column(
      children: [
        ...
        ElevatedButton(
            onPressed: () async {
              updateOtherExpense(id, tripid, type, details, amount_paid,
...
Future<Widget> editOtherForm(int id) async {
  OtherExpense dataMap;
  dataMap = await getItemByIdOtherExpense(id);
  var type,
      details,
