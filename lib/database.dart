...
class DatabaseHelper {
  ...
  void _onCreate(Database db, int version) async {
    ...
    await db.execute(
        'CREATE TABLE teip (tripid INTEGER PRIMARY KEY AUTOINCREMENT, title TEXT, start_date TEXT, end_date TEXT, complete INT, total REAL, fav INT, note TEXT, budget_head TEXT, last_modified TEXT, advance REAL, archive INT');
  }
}
